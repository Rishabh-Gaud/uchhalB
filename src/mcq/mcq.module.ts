...
@Module({
  imports: [
    MongooseModule.forFeature([
      ...
      { name: MathMCQ.name, schema: MathMCQSchema },
      { name: CPP.name, schema: CPPSchema },
      { name: CPrograming.name, schema: CProgramingSchema },
      { name: ArithmaticAptitude.name, schema: ArithmaticAptitudeSchema },
      { name: DataInterpretation.name, schema: DataInterpretationSchema },
      { name: LogicalReasoning.name, schema: LogicalReasoningSchema },
      { name: NonVerbalReasoning.name, schema: NonVerbalReasoningSchema },
      { name: VerbalReasoning.name, schema: VerbalReasoningSchema },
      { name: VerbalAbility.name, schema: VerbalAbilitySchema },
    ]),
  ],
